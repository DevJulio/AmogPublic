...
import AmogFont from "../assets/fonts/HeavyBoxingRegular.ttf";
import saloonGirl from "../assets/fonts/saloonGirl.ttf";
...
export const theme = {
  ...
  fonts: {
    primary: "Amog, sans-serif",
    secundary: "AmogNew, sans-serif;",
  },
